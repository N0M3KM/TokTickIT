...
| Field | Details |
|-------|---------|
| All reviewer name | *(to be filled after PRs are reviewed)* |
| All reviewer GitHub username | *(to be filled)* |
...
| #16 — Administrator User Management | `feature/16-admin-users` | feat(admin): minimalist User Management screen | *(PR URL)* | *(pending)* |
| #17 — E2E Tests and Release | `feature/17-lab3-e2e-and-release` | feat(e2e): Lab 3 E2E, responsive tests, and release | *(PR URL)* | *(pending)* |
| Release | `lab3-staging` → `main` | Release: Lab 3 to main | *(PR URL)* | *(pending)* |

---

## Feedback Received from My Reviewer

*(To be completed as PRs are reviewed)*
